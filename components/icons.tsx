...
export const CogIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.212l1.273-.636a1.125 1.125 0 011.37 1.37l-.636 1.273a1.125 1.125 0 00-1.212 1.11M17.88 9.91a1.125 1.125 0 011.37 1.37l-.636 1.273a1.125 1.125 0 01-1.212 1.11c-.542-.09-1.007-.56-1.212-1.11M12 10.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm12-3.75a2.25 2.25 0 00-2.25-2.25H6.75A2.25 2.25 0 004.5 6.75v10.5a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25V6.75z" />
    </Icon>
);
...
export const CheckCircleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props} strokeWidth="0" fill="currentColor">
        <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-1.814a.75.75 0 10-1.06-1.06L11.25 12.44l-1.82-1.82a.75.75 0 00-1.06 1.06l2.25 2.25a.75.75 0 001.06 0l4.5-4.5z" clipRule="evenodd" />
    </Icon>
);

export const CalendarPlusIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 14.25v-4.5m-2.25 2.25h4.5" />
    </Icon>
);
...
export const TennisRacketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M14 14l8 8" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 2.5v13" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.5 9h13" />
    </Icon>
);

export const PadelRacketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16 9a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.5 12.5l6 6" />
        <circle cx="9" cy="9" r="0.75" />
        <circle cx="12" cy="6.5" r="0.75" />
        <circle cx="6" cy="6.5" r="0.75" />
        <circle cx="12" cy="11.5" r="0.75" />
        <circle cx="6" cy="11.5" r="0.75" />
    </Icon>
);
